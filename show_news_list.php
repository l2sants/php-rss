...
function  show_news($file_name) {
    $idx = 0;          
    $doc = simplexml_load_file("../xml/". $file_name);
    $base = $doc->channel->item;
    $category_path = explode(".", $file_name)[0] . ".php";
    // $template_path = "./pages/templates/content_template.php";
            ...
            echo '<div class="p-3 d-flex justify-content-center">
                    <div class="card w-75">
                        <div class="card-body">
                            ...
                            <p class="text-monospace">'.substr($item->pubDate, 5, 11).'</p>
                            ...
                            <div class=" d-flex justify-content-center">
                                <form action="'.$category_path.'" method="POST" class="pt-4">
